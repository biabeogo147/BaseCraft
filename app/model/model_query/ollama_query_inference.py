...
if __name__ == "__main__":
    ...
    idea_result = query_idea_ollama(prompt, system_prompt_for_idea_model, app_config.LLAMA_MODEL_NAME)
    ...
    structure_result = query_structure_ollama(idea_result, system_prompt_for_structure_model, app_config.LLAMA_MODEL_NAME)
    ...
    programming = query_programming_ollama(structure_result, system_prompt_for_programming_model, app_config.LLAMA_MODEL_NAME)
